...
from eval import eval_net, validate
from unet import UNet

# from torch.utils.tensorboard import SummaryWriter
from utils.dataset import BasicDataset, MapDataset
from torch.utils.data import DataLoader, random_split

from utils.config import BATCH_SIZE, DATA_PATH, NUM_CLASSES, ignore_label, EPOCHS, GPUS, NUM_CHANNELS, CGT_EPOCHS, MAX_EPOCHS, ACC_CUT_TH
...
if __name__ == '__main__':
    ...
    weight_save_path = os.path.join(weight_path_prefix, folder_path)
