...
if TARGET_DATA_TYPE == "AP":  # 항공
  ...
  if TARGET_AREA == "HR":
    WEIGHT_PATH = "/workspace/unet/checkpoints/HR/AP"
  elif TARGET_AREA == "NR":
    WEIGHT_PATH = "20231113_2148_NR_AP"
  ...
  if TARGET_AREA == "HR":
    ...
    WEIGHT_PATH = "20231114_2218_NR_SS_622"
  ...
  if TARGET_AREA == "HR":
    WEIGHT_PATH = "new_test"
  elif TARGET_AREA == "NR":
    WEIGHT_PATH = "20231114_2146_NR_OS"
  # 10: 수변
  # 20: 비수변
