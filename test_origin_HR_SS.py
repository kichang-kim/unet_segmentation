...
from utils.config_HR_SS import NUM_CLASSES, DATA_PATH, NUM_CHANNELS, GPUS, WEIGHT_PATH
import evaluate_orig_HR_SS
...
if __name__ == "__main__":
    print("python test_origin_HR_SS.py --input data_HR/SS/test/ | tee evaluation_HR_SS.txt")
    args = get_args()
    # in_files = args.input
    ...
    for i, fn in enumerate(in_files):
        ...
        if not args.no_save:
            ...
            evaluate_orig_HR_SS.save_visible(visible_file, pred_max)
    ...
    evaluate_orig_HR_SS.calc_result_excel(result_save_path, test_label_path)