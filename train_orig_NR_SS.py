...
from eval_NR_SS import eval_net, validate
...
from utils.config_NR_SS import BATCH_SIZE, DATA_PATH, NUM_CLASSES, ignore_label, EPOCHS, GPUS, NUM_CHANNELS, CGT_EPOCHS, MAX_EPOCHS, ACC_CUT_TH
...
if __name__ == '__main__':
    ...
    weight_save_path = os.path.join(weight_path_prefix, 'NR_SS', folder_path)
