...
from utils.dataset_NR_OS import BasicDataset, MapDataset

from utils.config_NR_OS import NUM_CLASSES, DATA_PATH, NUM_CHANNELS, GPUS, WEIGHT_PATH
import evaluate_orig_NR_OS
...
if __name__ == "__main__":
    print("python test_origin_NR_OS.py --input data_NR/OS/test/ | tee evaluation_NR_OS.txt")
    args = get_args()
    # in_files = args.input
    ...
    for i, fn in enumerate(in_files):
        ...
        if not args.no_save:
            ...
            evaluate_orig_NR_OS.save_visible(visible_file, pred_max)
    ...
    evaluate_orig_NR_OS.calc_result_excel(result_save_path, test_label_path)